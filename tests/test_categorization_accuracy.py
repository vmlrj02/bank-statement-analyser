...
# Party formats surfaced by the low-confidence audit (CMS, PAYMENT TRANSFER, IMPS).
AUDIT_PARTY_3 = [
    ("CMS/001899604100/SHIV SHAKTICOLOUR HOUSE", -5000.0, "Regular debit", "SHIV SHAKTICOLOUR HOUSE"),
    ("PAYMENT TRANSFER CR -SHREE RENUKA STEELS", 5000.0, "Regular credit", "SHREE RENUKA STEELS"),
    ("IMPS/P2A/501323167432//TIMEZONE", 5000.0, "Regular credit", "TIMEZONE"),
...
# Corpus categorisation-sweep formats: SBI internet NEFT beneficiary, Axis
# POS/fuel merchant (IPS/VPS).
AUDIT_PARTY_5 = [
    ("TO TRANSFER-INB NEFT NEFT INB: NO: SBIN125291179844- CNAEMRPRP4 SUKUMAR TRANSFER TO 4698150044305 /", -5000.0, "Regular debit", "SUKUMAR"),
    ("IPS/IOCLFUEL/202505140532/000000006836/GURGAON", -5000.0, "Regular debit", "IOCLFUEL"),
